...
# =================================================================
# ✅ FIX: st.set_page_config MUST be the very first Streamlit command
# =================================================================
st.set_page_config(
...
def load_data():
    ...
    try:
        ...
        # Note: The assumption is 'Data Science Job Salaries.csv' is in the running directory.
...
if page == "1. Executive Summary 🚀":
    ...
    # 3. Distribution of salary by work year 
    with col_c:
